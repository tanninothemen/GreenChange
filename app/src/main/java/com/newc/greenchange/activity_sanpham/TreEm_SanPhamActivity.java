...
public class TreEm_SanPhamActivity extends AppCompatActivity {

    Toolbar toolbarTreEm;
    ListView lvSanPhamTreEm;
    SanPham_TreEm_Adapter treEm_adapter;
    ArrayList<SanPham> treEmArrayList;
    int iddogiadung=0;
    int page=1;
    View footerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tre_em__san_pham);
    ...
    private void LoadMoreData() {
        lvSanPhamTreEm.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(getApplicationContext(), ChiTietSanPhamActivity.class);
                intent.putExtra("thongtinsanpham", treEmArrayList.get(position));
                startActivity(intent);
            }
        });

        lvSanPhamTreEm.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response!=null && response.length()!=2){
                            lvSanPhamTreEm.removeFooterView(footerView);
                            try {
                                ...
                                for (int i=0;i<jsonArray.length();i++){
                                    ...
                                    treEmArrayList.add(new SanPham(idsanpham,tensanpham,hinhanhsanpham,chatlieu,thongtinsanpham,duonglink,maloai));
    ...
    private void Init() {
        toolbarTreEm=(Toolbar) findViewById(R.id.toolbarSPTreEm);
        lvSanPhamTreEm=(ListView) findViewById(R.id.listViewSPTreEm);
        treEmArrayList=new ArrayList<>();
        treEm_adapter=new SanPham_TreEm_Adapter(this,R.layout.dong_treem,treEmArrayList);
        lvSanPhamTreEm.setAdapter(treEm_adapter);
    ...
    public class myHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0:
                    lvSanPhamTreEm.addFooterView(footerView);
                    break;
                case 1:
                    GetData(++page);
                    isLoading=false;
