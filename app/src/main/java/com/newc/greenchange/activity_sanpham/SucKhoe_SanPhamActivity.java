...
public class SucKhoe_SanPhamActivity extends AppCompatActivity {

    Toolbar toolbarSucKhoe;
    ListView lvSanPhamSucKhoe;
    SanPham_SucKhoe_Adapter sucKhoe_adapter;
    ArrayList<SanPham> sucKhoeArrayList;
    int iddogiadung=0;
    int page=1;
    View footerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suc_khoe__san_pham);
    ...
    private void LoadMoreData() {
        lvSanPhamSucKhoe.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(getApplicationContext(), ChiTietSanPhamActivity.class);
                intent.putExtra("thongtinsanpham", sucKhoeArrayList.get(position));
                startActivity(intent);
            }
        });

        lvSanPhamSucKhoe.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response!=null && response.length()!=2){
                            lvSanPhamSucKhoe.removeFooterView(footerView);
                            try {
                                ...
                                for (int i=0;i<jsonArray.length();i++){
                                    ...
                                    sucKhoeArrayList.add(new SanPham(idsanpham,tensanpham,hinhanhsanpham,chatlieu,thongtinsanpham,duonglink,maloai));
    ...
    private void Init() {
        toolbarSucKhoe=(Toolbar) findViewById(R.id.toolbarSPSucKhoe);
        lvSanPhamSucKhoe=(ListView) findViewById(R.id.listViewSPSucKhoe);
        sucKhoeArrayList=new ArrayList<>();
        sucKhoe_adapter=new SanPham_SucKhoe_Adapter(this,R.layout.dong_suckhoe,sucKhoeArrayList);
        lvSanPhamSucKhoe.setAdapter(sucKhoe_adapter);
    ...
    public class myHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0:
                    lvSanPhamSucKhoe.addFooterView(footerView);
                    break;
                case 1:
                    GetData(++page);
                    isLoading=false;
