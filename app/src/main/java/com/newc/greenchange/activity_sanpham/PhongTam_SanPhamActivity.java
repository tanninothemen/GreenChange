...
import com.newc.greenchange.adapter_sanpham.SanPham_PhongTam_Adapter;
...
public class PhongTam_SanPhamActivity extends AppCompatActivity {
    Toolbar toolbarPhongTam;
    ListView lvSanPhamPhongTam;
    SanPham_PhongTam_Adapter phongTam_adapter;
    ArrayList<SanPham> phongTamArrayList;
    int iddogiadung=0;
    int page=1;
    View footerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phong_tam__san_pham);
    ...
    private void LoadMoreData() {
        lvSanPhamPhongTam.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(getApplicationContext(), ChiTietSanPhamActivity.class);
                intent.putExtra("thongtinsanpham", phongTamArrayList.get(position));
                startActivity(intent);
            }
        });

        lvSanPhamPhongTam.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response!=null && response.length()!=2){
                            lvSanPhamPhongTam.removeFooterView(footerView);
                            try {
                                ...
                                for (int i=0;i<jsonArray.length();i++){
                                    ...
                                    phongTamArrayList.add(new SanPham(idsanpham,tensanpham,hinhanhsanpham,chatlieu,thongtinsanpham,duonglink,maloai));
    ...
    private void Init() {
        toolbarPhongTam=(Toolbar) findViewById(R.id.toolbarSPPhongTam);
        lvSanPhamPhongTam=(ListView) findViewById(R.id.listViewSPPhongTam);
        phongTamArrayList=new ArrayList<>();
        phongTam_adapter=new SanPham_PhongTam_Adapter(this,R.layout.dong_phongtam,phongTamArrayList);
        lvSanPhamPhongTam.setAdapter(phongTam_adapter);
    ...
    public class myHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0:
                    lvSanPhamPhongTam.addFooterView(footerView);
                    break;
                case 1:
                    GetData(++page);
                    isLoading=false;
