...
import com.newc.greenchange.activity_sanpham.DoGD_SanPhamActivity;
...
public class DoGD_SanPhamActivity extends AppCompatActivity {

    //Biến toàn cục
    Toolbar toolbarDoGD;
    ListView lvSanPhamDoGD;
    SanPham_DoGD_Adapter doGD_adapter;
    ArrayList<SanPham> doGDArrayList;
    int iddogiadung=0;
    int page=1;
    View footerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_do_gd__san_pham);
        Init();
    ...
    //Hàm tải thêm dữ liệu cho danh sách
    private void LoadMoreData() {
        lvSanPhamDoGD.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(getApplicationContext(), ChiTietSanPhamActivity.class);
                intent.putExtra("thongtinsanpham", doGDArrayList.get(position));
                startActivity(intent);
            }
        });

        lvSanPhamDoGD.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
    ...
    //Hàm lấy dữ liệu đổ vào danh sách
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response!=null && response.length()!=2){
                            lvSanPhamDoGD.removeFooterView(footerView);
                            try {
                                ...
                                for (int i=0;i<jsonArray.length();i++){
                                    ...
                                    doGDArrayList.add(new SanPham(idsanpham,tensanpham,hinhanhsanpham,chatlieu,thongtinsanpham,duonglink,maloai));
                            ...
                            limitData=true;
                            lvSanPhamDoGD.removeFooterView(footerView);
                            Toast.makeText(DoGD_SanPhamActivity.this, "Bạn đã xem hết vật dụng trong loại này", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    //Hàm ánh xạ
    private void Init() {
        toolbarDoGD=(Toolbar) findViewById(R.id.toolbarSPDoGD);
        lvSanPhamDoGD=(ListView) findViewById(R.id.listViewSPDoGD);
        doGDArrayList=new ArrayList<>();
        doGD_adapter=new SanPham_DoGD_Adapter(this,R.layout.dong_dogd,doGDArrayList);
        lvSanPhamDoGD.setAdapter(doGD_adapter);
        LayoutInflater inflater= (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
        footerView=inflater.inflate(R.layout.progressbar_load,null);
        handler=new DoGD_SanPhamActivity.myHandler();
    }
    ...
    public class myHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0:
                    lvSanPhamDoGD.addFooterView(footerView);
                    break;
                case 1:
                    GetData(++page);
                    isLoading=false;
