...
public class SanPham_DuLich_Adapter extends BaseAdapter {
//Nguyễn Thành Quang
    private Context context;
    private int layout;
    private List<SanPham> SanPhamList;

    public SanPham_DuLich_Adapter(Context context, int layout, List<SanPham> SanPhamList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(context).load(SanPham.getHinhAnhSanPham()).fit().into(viewHolder.imgDuLich);
        viewHolder.txtTenDuLich.setText(SanPham.getTenSanPham());
        viewHolder.txtChatLieuDuLich.setText("Chất liệu: "+SanPham.getChatLieu());
        return convertView;
    }
}
